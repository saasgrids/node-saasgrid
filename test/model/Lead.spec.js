...
(function(root, factory) {
  ...
  describe('Lead', function() {
    it('should create an instance of Lead', function() {
      ...
      //var instane = new crms.Lead();
      //expect(instance).to.be.a(crms.Lead);
    });
    ...
    it('should have the property companyState (base name: "companyState")', function() {
      // uncomment below and update the code to test the property companyState
      //var instane = new crms.Lead();
      //expect(instance).to.be();
    });
    ...
    it('should have the property companyNumberOfEmployees (base name: "companyNumberOfEmployees")', function() {
      // uncomment below and update the code to test the property companyNumberOfEmployees
      //var instane = new crms.Lead();
      //expect(instance).to.be();
    });

    it('should have the property companyAnnualRevenue (base name: "companyAnnualRevenue")', function() {
      // uncomment below and update the code to test the property companyAnnualRevenue
      //var instane = new crms.Lead();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dealName (base name: "dealName")', function() {
      // uncomment below and update the code to test the property dealName
      //var instane = new crms.Lead();
      //expect(instance).to.be();
    });

    it('should have the property dealAmount (base name: "dealAmount")', function() {
      // uncomment below and update the code to test the property dealAmount
      //var instane = new crms.Lead();
      //expect(instance).to.be();
    });

    it('should have the property dealExpectedClose (base name: "dealExpectedClose")', function() {
      // uncomment below and update the code to test the property dealExpectedClose
      //var instane = new crms.Lead();
      //expect(instance).to.be();
    });
