...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new crms.InlineResponse2005();
  });
  ...
  describe('InlineResponse2005', function() {
    it('should create an instance of InlineResponse2005', function() {
      ...
      //var instane = new crms.InlineResponse2005();
      //expect(instance).to.be.a(crms.InlineResponse2005);
    });
    ...
    it('should have the property moreData (base name: "more_data")', function() {
      // uncomment below and update the code to test the property moreData
      //var instane = new crms.InlineResponse2005();
      //expect(instance).to.be();
    });
